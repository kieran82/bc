...
class VerifishOrderContract extends Contract {
    ...
    async initLedger(ctx) {
        ...
        const orders = [
            ...
            },
            {
                ...
                qtyUnitMeasurement: 'Kg',
                orderLines: [
                    { orderLine: 1, sourceBatchId: '102', tested: 'Yes', testDate: '10/01/2020', quantity: 400, qtyUnitMeasurement: 'Kg'},
                    { orderLine: 2, sourceBatchId: '1023', tested: 'Yes', testDate: '12/01/2020', quantity: 100, qtyUnitMeasurement: 'Kg'},
                ],
            },
            {
                orderId: '1003',
...
module.exports = VerifishOrderContract;
